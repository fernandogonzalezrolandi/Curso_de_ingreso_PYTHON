...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
       ...
       # alert(title="Alerta", message="Usted se llama " + nombre + " y su edad es " + edad + " años")
        alert(title="Alerta", message="Usted se llama {0} y su edad es {1} años".format(nombre, edad))
